            ...
            <ul>
              ...
              <li>
                <button
                  ...
                  className="w-full text-left px-2 py-1 text-red-700 disabled:opacity-50"
                >
                  {"Clear selection"}
                </button>
              </li>
          ...
          <ul ref={optionsListRef}>
            {options.map((option, i) => {
              return (
                <li key={option}>
                  <label
                    className={`flex text-blue-gray-900 font-thin text-xs whitespace-nowrap cursor-pointer px-2 py-1 transition-colors hover:bg-blue-gray-900/10 [&:has(input:checked)]:bg-blue-gray-900/20`}
                  >
                    <input
                      type="checkbox"
                      name={formFieldName}
